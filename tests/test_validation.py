        ...
        return pd.DataFrame(
            {
                ...
                "annual_income": [45000, 60000, 75000, 90000, 120000, 52000, 68000, 71000, 85000, 58000] * 3,
                "loan_amount": [10000, 15000, 20000, 25000, 30000, 12000, 17000, 21000, 26000, 14000] * 3,
                ...
                "marital_status": ["Single", "Married", "Married", "Single", "Divorced", "Single", "Married", "Married", "Single", "Divorced"] * 3,
                "employment_status": ["Employed", "Self-Employed", "Employed", "Employed", "Self-Employed", "Employed", "Employed", "Self-Employed", "Employed", "Employed"] * 3,
